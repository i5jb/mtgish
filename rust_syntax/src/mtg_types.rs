...
pub enum PlayerEffect {
  ...
  MayCastGraveyardCardForAlternateCastingCostWithEnterActions(CardInGraveyard, Box<Cost>, Vec<EnterFlag>),
  ...
  MayCastGraveyardCardWithEnterActions(CardInGraveyard, Vec<EnterFlag>),
...
pub enum ReplacementActionWouldDrawCost {
  DiscardACard,
  PutAGraveyardCardOntoBattlefield(Box<CardsInGraveyard>, Vec<EnterFlag>),
...
pub enum Cost {
  ...
  PutACardFromPlayersGraveyardOnBattlefield(CardsInGraveyard, Box<Player>, Vec<EnterFlag>),
...
pub enum Cards {
  ...
  SharesANameWithAGraveyardCard(Box<CardsInGraveyard>),
...
pub enum Action {
  ...
  PutEachGraveyardCardOntoBattlefieldFaceDownAsAnArtifactCreature(Box<CardsInGraveyard>, Vec<EnterFlag>, PT, CreatureType),
  ...
  PutExiledCardOnTheBottomOfItsOwnersLibrary(Box<CardInExile>),
  PutNumberCardsFromAmongPlayersGraveyardsOntoTheBattlefield(Box<GameNumber>, CardsInGraveyard, Box<Players>, Vec<EnterFlag>),
  ...
  Proliferate,
  ProliferateNumberTimes(Box<GameNumber>),
  PutACardFromAGraveyardOnBattlefield(CardsInGraveyard, Box<Players>, Vec<EnterFlag>),
  PutACardFromGraveyardIntoHand(Box<CardsInGraveyard>),
  ...
  PutEachGraveyardCardOntoBattlefield(Box<CardsInGraveyard>, Vec<EnterFlag>),
  ...
  PutGraveyardCardIntoHand(CardInGraveyard),
  PutGraveyardCardIntoHandOrOntoBattlefield(CardInGraveyard, Vec<EnterFlag>),
  PutGraveyardCardOntoBattlefield(CardInGraveyard, Vec<EnterFlag>),
  // PutGraveyardCardToTopOfLibrary(CardInGraveyard),
  ...
  PutUptoNumberGraveyardCardsOntoTheBattlefield(Box<GameNumber>, Box<CardsInGraveyard>, Vec<EnterFlag>),
  ...
  ReturnACardFromAnyPlayersGraveyardToBattlefield(CardsInGraveyard, Box<Players>, Vec<EnterFlag>),
  ...
  ReturnAnyNumberOfCardsFromGraveyardToBattlefield(CardsInGraveyard, Box<Player>, Vec<EnterFlag>),
  ReturnAnyNumberOfCardsFromGraveyardToHand(Box<Cards>),
  ReturnAnyNumberOfGroupCardsFromGraveyardToHand(Box<Cards>, GroupFilter),
  ReturnAnyNumberOfGroupCardsFromPlayersGraveyardToBattlefield(CardsInGraveyard, GroupFilter, Box<Player>, Vec<EnterFlag>),
  ...
  ReturnEachCardFromPlayersGraveyardToBattlefield(CardsInGraveyard, Box<Player>, Vec<EnterFlag>),
  ...
  ReturnEachGraveyardCardToBattlefield(Box<CardsInGraveyard>, Vec<EnterFlag>),
  ...
  ReturnNumberGraveyardCardsToBattlefieldAtRandom(Box<GameNumber>, Box<CardsInGraveyard>, Vec<EnterFlag>),
  ...
  ReturnUptoNumberCardsFromAmongPlayersGraveyardsToBattlefield(Box<GameNumber>, CardsInGraveyard, Box<Players>, Vec<EnterFlag>),
  ...
  SimultaneouslySacrificePermanentAndPutGraveyardCardOntoBattlefield(Box<Permanent>, CardInGraveyard, Vec<EnterFlag>),
