...
#[derive(Clone, Debug, serde::Deserialize, serde::Serialize, bincode::Encode, bincode::Decode, ts_rs::TS)]
#[ts(export)]
#[cfg_attr(feature = "write_out_json", serde(tag = "_CounterTypes", content = "args"))]
...
pub enum PlayerEffect {
  ...
  MayCastASpellFromAmongCardsInPlayersGraveyardOnceEachTurn(Box<Spells>, CardsInGraveyard, Box<Player>),
  ...
  MayCastSpellsFromAmongCardsInPlayersGraveyardForAlternateCost(Box<Spells>, CardsInGraveyard, Box<Player>, Box<Cost>),
  ...
  AsTheyCascadeTheyMayPutACardFromAmongExiledCardsOnBattlefiled(Box<Cards>, Vec<ReplacementActionWouldEnter>),
  ...
  MayCastGraveyardCardForAlternateCastingCostWithEnterActions(CardInGraveyard, Box<Cost>, Vec<ReplacementActionWouldEnter>),
  ...
  MayPayAdditionalCostToCastSpellsForEffect(Box<Spells>, Box<Cost>, Vec<ReplacementActionWouldEnter>),
...
pub enum Rule {
  ...
  EachCardInAGraveyardEffect(Box<CardsInGraveyard>, Box<Players>, Vec<GraveyardCardEffect>),
...
pub enum Condition {
  ...
  TheNumberOfCountersOfTypePutOnPermanentsThisWayIs(CounterType, Box<Permanents>, Box<Comparison>),
  ...
  CardIsInPlayersGraveyardWithANumberOfCardsAboveIt(CardInGraveyard, Box<Player>, Box<Comparison>, Box<Cards>),
...
pub enum SearchLibraryAction {
  ...
  MayPutACardOfTypeOntoTheBattlefieldOrAGenericCardIntoHand(Box<Cards>, Vec<ReplacementActionWouldEnter>),
  ...
  MayPutAnyNumberOfGroupCardsOntoBattlefield(Box<Cards>, GroupFilter, Vec<ReplacementActionWouldEnter>),
  MayPutAnyNumberOfGroupCardsOntoTheBattlefield(Box<Cards>, GroupFilter, Vec<ReplacementActionWouldEnter>),
  MayPutMultipleCardsOfTypeOntoTheBattlefield(Vec<Cards>, Vec<ReplacementActionWouldEnter>),
  MayPutUptoNumberCardsOntoTheBattlefield(Box<GameNumber>, Box<Cards>, Vec<ReplacementActionWouldEnter>),
  MayPutUptoNumberGenericCardsIntoHand(Box<GameNumber>),
  MayPutUptoNumberGroupCardsOntoBattlefield(Box<GameNumber>, Box<Cards>, GroupFilter, Vec<ReplacementActionWouldEnter>),
...
pub enum Cost {
  ...
  RemoveACounterOfTypeFromEachOfNumberPermanents(Box<CounterType>, Box<GameNumber>, Box<Permanents>),
  ...
  PutACardFromHandOrGraveyardOnBattlefield(Box<Cards>, Box<Player>, Vec<ReplacementActionWouldEnter>),
  PutACardFromPlayersGraveyardOnBattlefield(CardsInGraveyard, Box<Player>, Vec<ReplacementActionWouldEnter>),
  ...
  RemoveNumberCountersOfTypeFromPermanent(Box<GameNumber>, CounterType, Box<Permanent>),
  RemoveNumberOrMoreCountersOfTypeFromAmongPermanents(Box<GameNumber>, CounterType, Box<Permanents>),
...
pub enum GameNumber {
  ...
  TheNumberOfCardsInPlayersGraveyardThatWerePutThereFromTheBattlefieldThisTurn(Box<Cards>, Box<Player>),
...
#[derive(Clone, Debug, serde::Deserialize, serde::Serialize, bincode::Encode, bincode::Decode, ts_rs::TS)]
#[ts(export)]
#[cfg_attr(feature = "write_out_json", serde(tag = "_GraveyardCard", content = "args"))]
...
#[derive(Clone, Debug, serde::Deserialize, serde::Serialize, bincode::Encode, bincode::Decode, ts_rs::TS)]
#[ts(export)]
#[cfg_attr(feature = "write_out_json", serde(tag = "_CardsInGraveyard", content = "args"))]
...
pub enum LookAtTopOfLibraryAction {
  ...
  MayPutUptoNumberGroupCardsOntoTheBattlefield(Box<GameNumber>, Box<Cards>, GroupFilter, Vec<ReplacementActionWouldEnter>),
...
pub enum RevealTheTopNumberCardsOfLibraryAction {
  ...
  APlayerMayPutACardOfTypeOntoTheBattlefield(Box<Players>, Box<Cards>, Vec<ReplacementActionWouldEnter>),
  ...
  MayPutMultipleCardsOfTypeIntoHandOrOntoTheBattlefield(Vec<Cards>, Vec<ReplacementActionWouldEnter>),
  MayPutTheCardFoundThisWayOntoTheBattlefield(Vec<ReplacementActionWouldEnter>),
  MayPutUptoNumberCardsOfTypeOntoTheBattlefield(Box<GameNumber>, Box<Cards>, Vec<ReplacementActionWouldEnter>),
  MayPutUptoNumberGroupCardsOntoTheBattlefield(Box<GameNumber>, Box<Cards>, GroupFilter, Vec<ReplacementActionWouldEnter>),
...
pub enum Action {
  ...
  PutACardAndOrACardFromHandOnBattlefield(Box<CardsInHand>, Box<CardsInHand>, Vec<ReplacementActionWouldEnter>),
  PutCountersOfDeadPermanentOnEachPermanent(Box<Permanents>),
  MayCastASpellFromAmongGraveyardCardsIntoExileOrBattlefield(Box<Spells>, Box<CardsInGraveyard>),
  ...
  PutEachCardOfTypeMilledThisWayOntoTheBattlefield(Box<CardsInLibrary>, Vec<ReplacementActionWouldEnter>),
  PutGraveyardCardOnBottomOfLibrary(Box<CardInGraveyard>),
  ...
  ConjureADuplicateOfPermanentOntoTheBattlefield(Box<Permanent>, Vec<ReplacementActionWouldEnter>),
  ...
  ForEachPermanentPutUptoNumberCountersOfTypeOnIt(Box<Permanents>, Box<GameNumber>, Box<CounterType>),
  ...
  ForEachValueInRangeConjureDuplicateOfARandomCardOfTypeOntoBattlefield(Box<GameNumber>, Box<GameNumber>, Box<Cards>, Vec<ReplacementActionWouldEnter>),

  PutAPermanentIntoItsOwnersHand(Box<Permanents>),

  PutACounterOfTypeOnAPermanentOfEachColor(CounterType, Box<Permanents>),
  PutEachGraveyardCardOntoBattlefieldFaceDownAsAnArtifactCreature(Box<CardsInGraveyard>, Vec<ReplacementActionWouldEnter>, PT, CreatureType),
  ...
  RemoveUptoNumberCountersOfTypeFromAmongPermanents(Box<GameNumber>, CounterType, Box<Permanents>),
  ...
  ConjureNumberCardsOntoBattlefield(Box<GameNumber>, NameString, Vec<ReplacementActionWouldEnter>),
  ...
  ForEachPermanentConjureCardOntoBattlefield(Box<Permanents>, NameString, Vec<ReplacementActionWouldEnter>),
  ConjureADuplicateOfEachPermanentIntoGraveyard(Box<Permanents>),
  ConjureDuplicateOfARandomCardOfTypeOntoBattlefield(Box<Cards>, Vec<ReplacementActionWouldEnter>),
  ...
  CreatePerpetualPermanentOrGraveyardCardEffect(Box<Permanent>, Box<CardInGraveyard>, Vec<PerpetualEffect>),
  ...
  PutNumberCountersOfTypeAndACounterOfTypeOnPermanent(Box<GameNumber>, CounterType, CounterType, Box<Permanent>),
  PutUptoOneCardOfEachCardtypeAmongPermanentsFromHandOnTheBattlefield(Box<Permanents>, Vec<ReplacementActionWouldEnter>),
  ...
  PutACardOfTypeAndOrACardOfTypeMilledThisWayOntoTheBattlefield(Vec<Cards>, Vec<ReplacementActionWouldEnter>),
  PutACardOfTypeMilledThisWayIntoHand(Box<Cards>),
  RemoveACounterFromPlayer(Box<Player>),
  PutAnyNumberOfCardsOfTypeMilledThisWayOntoTheBattlefield(Box<Cards>, Vec<ReplacementActionWouldEnter>),
  ...
  PutUptoNumberCardsFromHandAndOrGraveyardOnBattlefield(Box<GameNumber>, Box<Cards>, Box<Player>, Vec<ReplacementActionWouldEnter>),
  PutNumberCardsFromExileOntoBattlefield(Box<GameNumber>, CardsInExile, Vec<ReplacementActionWouldEnter>),
  ...
  PutExiledCardOnTheBottomOfItsOwnersLibrary(Box<CardInExile>),
  PutNumberCardsFromAmongPlayersGraveyardsOntoTheBattlefield(Box<GameNumber>, CardsInGraveyard, Box<Players>, Vec<ReplacementActionWouldEnter>),
  MayPutACardFromHandOrGraveyardOnBattlefieldForEachPermanent(Box<Cards>, Vec<ReplacementActionWouldEnter>, Box<Permanents>),
  ...
  DistributeNumberCountersOfTypeAmongAnyNumberOfPermanentsGreaterThanZero(Box<GameNumber>, CounterType, Box<Permanents>),
  ...
  CounterSpell(Box<Spell>),
  CounterSpellAndSpellsOfTypeAreCounteredOntoTheBattlefield(Box<Spell>, Box<Spells>, Vec<ReplacementActionWouldEnter>),
  ...
  CreatePerpetualCardsInPlayersGraveyardEffect(CardsInGraveyard, Box<Player>, Vec<PerpetualEffect>),
  ...
  ExileGraveyardCard(CardInGraveyard),
  ExileGraveyardCardEachCardInEachPlayersGraveyardAndEachPermanent(CardInGraveyard, Box<Cards>, Box<Players>, Box<Permanents>),
  ...
  ExilePermanentsAndMeldIntoNewPermanent(Box<Permanent>, Box<Permanents>, NameString, Vec<ReplacementActionWouldEnter>),
  ExilePlayersGraveyard(Box<Player>),
  ...
  LookAtPlayersHandAndChooseACardToPutOnBattlefield(Box<Player>, Box<Cards>, Vec<ReplacementActionWouldEnter>),
  ...
  MoveACounterOfTypeFromPermanentOntoAnotherPermanent(CounterType, Box<Permanent>, Box<Permanent>),
  ...
  MoveAllCountersOfTypeFromEachPermanentOntoPermanent(CounterType, Box<Permanents>, Box<Permanent>),
  ...
  MoveAnyNumberOfCountersOfTypeFromPermanentOntoNewPermanent(CounterType, Box<Permanent>, Box<Permanent>),
  MoveAnyNumberOfCountersOfTypeFromPermanentOntoNewPermanents(CounterType, Box<Permanent>, Box<Permanents>),
  MoveAnyNumberOfCountersOfTypeFromPermanentsOntoNewPermanent(CounterType, Box<Permanents>, Box<Permanent>),
  MoveNumberCountersOfTypeFromPermanentOntoAnotherPermanent(Box<GameNumber>, CounterType, Box<Permanent>, Box<Permanent>),
  ...
  Proliferate,
  ProliferateNumberTimes(Box<GameNumber>),
  PutACardFromAGraveyardOnBattlefield(CardsInGraveyard, Box<Players>, Vec<ReplacementActionWouldEnter>),
  PutACardFromGraveyardIntoHand(Box<CardsInGraveyard>),
  ...
  PutARandomCardFromPlayersLibraryOntoBattlefield(Box<Cards>, Box<Player>, Vec<ReplacementActionWouldEnter>),
  ...
  PutAbilityCountersOnAPermanentFromAbilitiesOnCardsInPlayersGraveyard(Box<Permanents>, Vec<CheckHasable>, Box<Cards>, Box<Player>),
  ...
  PutAnyNumberOfCardsFromAmongExileOntoBattlefield(Box<Cards>, CardsInExile, Vec<ReplacementActionWouldEnter>),
  ...
  PutAnyNumberOfCardsFromHandOrFromPlayersGraveyardOnBattlefield(Box<Cards>, Box<Player>, Vec<ReplacementActionWouldEnter>),
  ...
  PutEachCardFromEachPlayersGraveyardOntoTheBattlefield(Box<Cards>, Box<Players>, Vec<ReplacementActionWouldEnter>),
  ...
  PutNumberCountersOfTypeOnPermanent(Box<GameNumber>, CounterType, Box<Permanent>),
  PutNumberCountersOfTypeOnPermanentForEach(Box<GameNumber>, CounterType, Box<Permanent>, Box<GameNumber>),
  ...
  PutUptoNumberCardsFromHandOntoBattlefield(Box<GameNumber>, Box<Cards>, Vec<ReplacementActionWouldEnter>),
  PutUptoNumberCountersOfTypeOnPermanentWithMaxTotal(Box<GameNumber>, CounterType, Box<Permanent>, Box<GameNumber>),
  PutUptoNumberGraveyardCardsOntoTheBattlefield(Box<GameNumber>, Box<CardsInGraveyard>, Vec<ReplacementActionWouldEnter>),
  ...
  RemoveNumberCountersOfTypeFromPermanent(Box<GameNumber>, CounterType, Box<Permanent>),
  RemoveNumberCountersOfTypeFromPermanentOrExiled(Box<GameNumber>, CounterType, PermanentOrExiledCard),
  ...
  RestartTheGameLeavingEachExiledCardInExileThenPutThoseCardsOntoTheBattlefield(CardsInExile, Vec<ReplacementActionWouldEnter>),
  ReturnACardFromAnyPlayersGraveyardToBattlefield(CardsInGraveyard, Box<Players>, Vec<ReplacementActionWouldEnter>),
  ...
  ReturnACardFromPlayersGraveyardToBattlefield(Box<Cards>, Box<Player>, Vec<ReplacementActionWouldEnter>),
  ...
  ReturnAnyNumberOfCardsFromGraveyardToBattlefield(CardsInGraveyard, Box<Player>, Vec<ReplacementActionWouldEnter>),
  ReturnAnyNumberOfCardsFromGraveyardToHand(Box<Cards>),
  ReturnAnyNumberOfGroupCardsFromGraveyardToHand(Box<Cards>, GroupFilter),
  ReturnAnyNumberOfGroupCardsFromPlayersGraveyardToBattlefield(CardsInGraveyard, GroupFilter, Box<Player>, Vec<ReplacementActionWouldEnter>),
  ReturnAnyNumberOfGroupCardsMilledThisWayToBattlefield(Box<Cards>, GroupFilter, Vec<ReplacementActionWouldEnter>),
  ...
  ReturnEachCardFromEachPlayersGraveyardToBattlefieldThatWasPutThereFromAnywhereThisTurn(Box<Cards>, Box<Players>, Vec<ReplacementActionWouldEnter>),
  ReturnEachCardFromEachPlayersGraveyardToBattlefieldThatWasPutThereFromTheBattlefieldThisTurn(Box<Cards>, Box<Players>, Vec<ReplacementActionWouldEnter>),
  ...
  ReturnEachCardFromPlayersGraveyardToBattlefield(CardsInGraveyard, Box<Player>, Vec<ReplacementActionWouldEnter>),
  ReturnEachCardFromPlayersGraveyardToBattlefieldThatWasDestroyThisWay(Box<Cards>, Box<Player>, Vec<ReplacementActionWouldEnter>),
  ReturnEachCardFromPlayersGraveyardToBattlefieldThatWasPutThereFromBattlefieldThisTurn(Box<Cards>, Box<Player>, Vec<ReplacementActionWouldEnter>),
  ...
  ReturnMultipleCardsFromPlayersGraveyardToBattlefield(Vec<Cards>, Box<Player>, Vec<ReplacementActionWouldEnter>),
  ReturnNewGraveyardCardToBattlefield(Vec<ReplacementActionWouldEnter>),
  ReturnNumberCardsFromGraveyardToBattlefield(Box<GameNumber>, Box<Cards>, Vec<ReplacementActionWouldEnter>),
  ReturnNumberCardsFromGraveyardToBattlefieldAtRandom(Box<GameNumber>, Box<Cards>, Vec<ReplacementActionWouldEnter>),
  ...
  ReturnNumberGraveyardCardsToBattlefieldAtRandom(Box<GameNumber>, Box<CardsInGraveyard>, Vec<ReplacementActionWouldEnter>),
  ...
  ReturnUptoNumberCardsFromAmongPlayersGraveyardsToBattlefield(Box<GameNumber>, CardsInGraveyard, Box<Players>, Vec<ReplacementActionWouldEnter>),
  ReturnUptoNumberCardsFromExileToOwnersHand(Box<GameNumber>, CardsInExile),
  ReturnUptoNumberCardsFromPlayersGraveyardToBattlefield(Box<GameNumber>, Box<Cards>, Box<Player>, Vec<ReplacementActionWouldEnter>),
  ReturnUptoNumberPermanentsToOwnersHand(Box<GameNumber>, Box<Permanents>),
  ReturnUptoOneCardOfEachPermanentTypeInPlayersGraveyardToBattlefield(Box<Player>, Vec<ReplacementActionWouldEnter>),
  RevealACardFromHand,
  RevealACardFromHandAtRandom,
  ...
  RevealHandAndPlayerChoosesACardToPutOnBattlefield(Box<Player>, Box<Cards>, Vec<ReplacementActionWouldEnter>),
  ...
  SimultaneouslySacrificePermanentAndPutGraveyardCardOntoBattlefield(Box<Permanent>, CardInGraveyard, Vec<ReplacementActionWouldEnter>),
...
pub enum Trigger {
  ...
  // exile
  WhenAnyNumberOfPermanentsAndOrGraveyardCardsArePutIntoExile(Box<Permanents>, Box<CardsInGraveyard>),
  ...
  WhenAnyNumberOfCountersOfTypeArePutOnAPermanentForTheFirstTimeEachTurn(CounterType, Box<Permanents>),
